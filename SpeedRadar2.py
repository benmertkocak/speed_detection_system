...
cap = cv2.VideoCapture(r"C:\Users\mertk\Downloads\traffic4.mp4")
f = 25
w = int(1000/(f-1))
...
while True:
    ...
    for box_id in boxes_ids:
        ...
        if(tracker.getsp(id)<tracker.limit()):
            cv2.putText(roi, "ID:{} - {}km/h".format(id, tracker.getsp(id)), (x, y-15), cv2.FONT_HERSHEY_PLAIN, 1, (255, 255, 0), 2)
            cv2.rectangle(roi, (x, y), (x + w, y + h), (0, 255, 0), 3)
        else:
